...
public class Tan_Momentum extends Momentum {

    public Tan_Momentum(ArrayList<ArrayList<Double>> dataset, ArrayList<ArrayList<Double>> valDataset, int nodes, int epochs) throws IOException {
