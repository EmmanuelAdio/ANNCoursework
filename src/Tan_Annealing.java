...
public class Tan_Annealing extends Annealing{
    public Tan_Annealing(ArrayList<ArrayList<Double>> dataset, ArrayList<ArrayList<Double>> valDataset, int nodes, int epochs) throws IOException {
