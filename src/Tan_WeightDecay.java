...
public class Tan_WeightDecay extends  WeightDecay{
    public Tan_WeightDecay(ArrayList<ArrayList<Double>> dataset, ArrayList<ArrayList<Double>> valDataset, int nodes, int epochs) throws IOException {
