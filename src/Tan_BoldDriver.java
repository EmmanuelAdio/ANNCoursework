...
public class Tan_BoldDriver extends BackPropagation{
    ...
    public Tan_BoldDriver(ArrayList<ArrayList<Double>> dataset, ArrayList<ArrayList<Double>> valDataset, int nodes, int epochs) throws IOException {
