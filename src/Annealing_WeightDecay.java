...
public class Annealing_WeightDecay extends WeightDecay{
    public Annealing_WeightDecay(ArrayList<ArrayList<Double>> dataset, ArrayList<ArrayList<Double>> valDataset, int nodes, int epochs) throws IOException {
